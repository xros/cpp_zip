...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_TestQuaZipDir_t, stringdata) + ofs \
...
const QMetaObject TestQuaZipDir::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaZipDir.data,
      qt_meta_data_TestQuaZipDir,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TestQuaZipDir.stringdata))
