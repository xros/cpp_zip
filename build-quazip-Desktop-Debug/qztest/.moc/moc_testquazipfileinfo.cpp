...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_TestQuaZipFileInfo_t, stringdata) + ofs \
...
const QMetaObject TestQuaZipFileInfo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaZipFileInfo.data,
      qt_meta_data_TestQuaZipFileInfo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TestQuaZipFileInfo.stringdata))
