...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_TestQuaZIODevice_t, stringdata) + ofs \
...
QT_MOC_LITERAL(4, 32, 5)
    ...
    "TestQuaZIODevice\0read\0\0readMany\0write\0"
};
...
const QMetaObject TestQuaZIODevice::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaZIODevice.data,
      qt_meta_data_TestQuaZIODevice,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TestQuaZIODevice.stringdata))
