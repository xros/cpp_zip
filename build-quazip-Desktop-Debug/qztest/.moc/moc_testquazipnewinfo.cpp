...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_TestQuaZipNewInfo_t, stringdata) + ofs \
...
QT_MOC_LITERAL(2, 35, 0)
    ...
    "TestQuaZipNewInfo\0setFileNTFSTimes\0\0"
};
...
const QMetaObject TestQuaZipNewInfo::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaZipNewInfo.data,
      qt_meta_data_TestQuaZipNewInfo,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TestQuaZipNewInfo.stringdata))
