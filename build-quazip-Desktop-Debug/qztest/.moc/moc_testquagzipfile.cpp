...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_TestQuaGzipFile_t, stringdata) + ofs \
...
const QMetaObject TestQuaGzipFile::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_TestQuaGzipFile.data,
      qt_meta_data_TestQuaGzipFile,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_TestQuaGzipFile.stringdata))
